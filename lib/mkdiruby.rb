...
def create_folder(name)
    Dir.mkdir("/Desktop/THP/Projet/#{name}")
...
def lib_creation
    Dir.mkdir("/Desktop/THP/Projet/#{name}/lib")
end
...
def setup_file_creation(project_name)
    ...
    README = File.open("Desktop/THP/Projet/#{project_name}/README.md", "w")
    Gemfile = File.open("Desktop/THP/Projet/#{project_name}/Gemfile.md", "w")
    gitignore = File.open("Desktop/THP/Projet/#{project_name}/.gitignore", "w")
    env = File.open("Desktop/THP/Projet/#{project_name}/.env", "w")
